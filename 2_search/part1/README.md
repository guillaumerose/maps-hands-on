...
```
Notre service de recherche est prêt à s'intégrer dans notre interface. Rendez-vous à la [partie 2](https://github.com/guillaumerose/maps-hands-on/tree/master/search/part2).