...
...
```
5. Relancez le serveur HTTP de test de la partie 3 et cherchez les arrêts STIF. Par exemple, la requête `arrêt stif` affichera les premier arrêts rencontrés par Pelias. Si les résultats ne sont pas pertinents, ajustez le slider à la fin de la [partie 3](../part3).
